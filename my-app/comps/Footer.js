        ...
        <div className={styles.whole}>
            ...
            <div className={styles.iconfootersecs}>              
              <a href="https://github.com/VinGuar?tab=repositories" target="_blank">
                <img alt="github logo" className={styles.iconfooter} style ={{"width":"65px","opacity":"0.85"}} src="github.png" />
              </a>
              <a href="https://www.linkedin.com/in/vincent-guarnieri-5343a8278/" target="_blank">
                <img alt="linkedin logo" className={styles.iconfooter} style ={{"width": "53px", "opacity":"0.68"}} src="linked.png" />
              </a>
            </div>
